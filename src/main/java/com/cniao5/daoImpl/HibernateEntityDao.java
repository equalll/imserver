...
import com.cniao5.dao.IEntityDao;
import com.cniao5.util.BeanUtils;
import com.cniao5.util.GenericsUtils;
import com.cniao5.util.Page;
...
public class HibernateEntityDao<T, PK extends Serializable> extends HibernateDaoSupport implements IEntityDao<T, PK> {
     ...
     * 实际调用Hibernate的session.load()方法返回实体或其proxy代理对象. 如果对象不存在，抛出异常.
     *
     * @param id
     */
     ...
     * 创建Criteria对象.
     *
     * @param criterions 可变的Restrictions限制性条件列表
     */
